  ...
  return (
    <Fragment>
            ...
            <div className="flex flex-wrap justify-between -mx-3 mb-4">
              <div className="w-full md:w-1/2 mb-4 px-3 md:mb-0">
                <label htmlFor="card" className="h-0 overflow-hidden w-0 block relative">Card
                  Number</label>
                <input type="number" placeholder="Card Number" className="form-input"
                     id="card"/>
              </div>
            ...
            <div className="flex flex-wrap justify-between -mx-3 mb-4">
              <div className="w-full md:w-1/2 px-3 mb-4 md:mb-0">
                <label htmlFor="expiration_date"
                     className="h-0 overflow-hidden w-0 block relative">Expiration
                  Date</label>
                <input type="number" placeholder="Expiration date (MM/YY)"
                     className="form-input" id="expiration_date"/>
              </div>
              <div className="w-full md:w-1/2 px-3">
                <label htmlFor="code" className="h-0 overflow-hidden w-0 block relative">Security
                  Code</label>
                <input type="number" placeholder="Security code" className="form-input"
                     id="code"/>
              </div>
            </div>
          </div>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center pt-8 sm:pt-12">
        ...
        <Link
          to="/cart"
          className="flex items-center mb-3 sm:mb-0 font-hkregular group-hover:font-hkbold text-sm text-secondary hover:text-primary group transition-colors"><i
          className="bx bx-chevron-left text-secondary group-hover:text-primary pr-2 text-xl transition-colors"></i>
          Return to Cart
        </Link>
