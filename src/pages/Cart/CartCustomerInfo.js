        ...
        ">Payment method</a>
                    ...
                    <div className="pt-10 md:pt-12">
                        ...
                        <div className="pt-4 md:pt-5">
                            ...
                            <input type="email" placeholder="Enter your email address" className="form-input" id="email" />
                    ...
                    <div className="pt-4 pb-10">
                        ...
                        <div className="pt-4 md:pt-5">
                            ...
                            Name</label>
                                <input type="text" placeholder="First Name" className="form-input mb-4 sm:mb-5 mr-2" id="first_name" />
                                <label for="last_name" className="block relative h-0 w-0 overflow-hidden">Last
                            Name</label>
                                <input type="text" placeholder="Last Name" className="form-input mb-4 sm:mb-5 ml-1" id="last_name" />
                            </div>
                            <label for="address" className="block relative h-0 w-0 overflow-hidden">Address</label>
                            <input type="text" placeholder="You address" className="form-input mb-4 sm:mb-5" id="address" />
                            <label for="address2" className="block relative h-0 w-0 overflow-hidden">Address
                        2</label>
                            <input type="text" placeholder="Apartment, Suite, etc" className="form-input mb-4 sm:mb-5" id="address2" />
                            ...
                            <div className="flex justify-between">
                                ...
                                <input type="text" placeholder="Country/Region" className="form-input mb-4 sm:mb-5 mr-2" id="country" />
                                <label for="post_code" className="block relative h-0 w-0 overflow-hidden">Post
                            code</label>
                                <input type="number" placeholder="Post code" className="form-input mb-4 sm:mb-5 ml-1" id="post_code" />
                            </div>
                        ...
                        <div className="flex flex-col sm:flex-row justify-between items-center pt-8 sm:pt-12">
                            <a href="/cart" className="flex items-center mb-3 sm:mb-0 font-hkregular group-hover:font-hkbold text-sm text-secondary hover:text-primary group transition-all">
                                <i className="bx bx-chevron-left text-secondary group-hover:text-primary pr-2 text-xl transition-colors"></i>
                        Return to Cart
                    </a>
                            <a href="/shipping-method" className="btn btn-primary">
