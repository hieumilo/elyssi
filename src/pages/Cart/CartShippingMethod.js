    ...
    return (
        ...
        ">Payment method</a>
                        ...
                        <div className="mt-5 md:mt-6 border border-grey-darker rounded px-4 sm:px-5">
                            <div className="flex justify-between border-b border-grey-dark py-2">
                                <div className="flex items-center">
                                    <label htmlFor="shipping_international" className="block relative h-0 w-0 overflow-hidden">International
                                Shipping</label>
                    ...
                    <div className="flex flex-col-reverse sm:flex-row justify-between items-center pt-8 sm:pt-12">
                        <a href="/cart" className="flex items-center  font-hkregular group-hover:font-hkbold text-sm text-secondary hover:text-primary group transition-colors">
                            <i className="bx bx-chevron-left text-secondary group-hover:text-primary pr-2 text-xl transition-colors"></i>
                    Return to Cart
                </a>
                        <a href="/payment-method" className="btn btn-primary mb-3 sm:mb-0">
